...
class SayartiServiceScreen extends StatefulWidget {
  static var tag = "/SayartiServiceScreen";

  @override
  SayartiServiceScreenState createState() => SayartiServiceScreenState();
}

class SayartiServiceScreenState extends State<SayartiServiceScreen> {
  double? width;
