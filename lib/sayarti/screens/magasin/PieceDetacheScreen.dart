...
class PieceDetacheScreen extends StatefulWidget {
  @override
  PieceDetacheScreenState createState() => PieceDetacheScreenState();
}

class PieceDetacheScreenState extends State<PieceDetacheScreen> {
